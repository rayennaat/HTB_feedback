    ...
    <main className="app-shell px-4 py-8 text-stone-950 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <section className="rounded-lg border border-stone-200/80 bg-white p-6 shadow-[0_8px_24px_rgba(37,31,24,0.06)]">
          ...
          <h1 className="mt-3 text-4xl font-bold tracking-tight text-stone-950">Reach Feedback Hub</h1>
          <p className="mt-4 text-base leading-7 text-stone-600">For moderation issues, safety concerns, partnership questions, or product feedback, contact the Feedback Hub team.</p>
