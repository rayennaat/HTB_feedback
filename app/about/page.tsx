    ...
    <main className="app-shell px-4 py-8 text-stone-950 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl">
        ...
        <section className="rounded-lg border border-stone-200/80 bg-white p-6 shadow-[0_8px_24px_rgba(37,31,24,0.06)]">
          <p className="text-sm font-semibold uppercase tracking-wide text-teal-700">About Feedback Hub</p>
          <h1 className="mt-3 text-4xl font-bold tracking-tight text-stone-950">A public place for real service experiences.</h1>
          <div className="mt-5 space-y-4 text-base leading-7 text-stone-600">
            <p>Feedback Hub helps people in your area share practical experiences about companies, shops, services, jobs, delivery, call centers, restaurants, telecom, banks, public services, and online shopping.</p>
